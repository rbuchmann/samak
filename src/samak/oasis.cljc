...
(defn start
  ...
  (let [oasis [(defncall 'ui (api/symbol 'pipes/ui))
               ...
               (defmap 'css-background
                 {(api/keyword :width) (api/string "600px")
               ...
               (defmap 'pop-current
                 {(api/keyword :stack) (api/fn-call (api/symbol '->)
                                                    [(api/key-fn :stack)
               ...
               (defmap 'format-def
                 {(api/keyword :id) (api/symbol 'def-name)
